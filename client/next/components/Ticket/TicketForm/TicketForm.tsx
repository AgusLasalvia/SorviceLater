...
import { Knowledge, User, Ticket } from "@/types";
import { useState } from "react";

interface TicketFormProps {
  props: Ticket;
  admins: User[] | [];
  knowledgels: Knowledge[] | [];
  method: string;
}
        ...
        <div className="topGrid">
          ...
          <div className="gridcontent" id="div2">
            ...
            <input
              ...
              className="input"
              type="text"
              placeholder={props.reqBy}
              onChange={(e) => {
                setTicket({ ...ticket, reqBy: e.target.value });
              }}
            />
          </div>
          ...
          <div className="gridcontent" id="div3">
            ...
            <input
              ...
              className="input"
              type="text"
              placeholder={props?.reqFor}
              onChange={(e) => {
                setTicket({ ...ticket, reqFor: e.target.value });
              }}
            />
          </div>
          ...
          <div className="gridcontent" id="div4">
            ...
            <input
              ...
              className="input"
              type="text"
              placeholder={props?.srvcOf}
              onChange={(e) => {
                setTicket({ ...ticket, srvcOf: e.target.value });
              }}
            />
          </div>
          ...
          <div className="gridcontent" id="div5">
            ...
            <input
              ...
              className="input"
              type="text"
              placeholder={ticket.confItem}
              onChange={(e) => {
                setTicket({ ...ticket, confItem: e.target.value });
              }}
            />
          </div>
